(function ($) {
    ...
    $.fn.colorPalettePicker.defaults = {
        ...
        palette: ['aqua', 'azure', 'beige', 'brown', 'black', 'blue', 'cyan', 'darkblue', 
        'darkcyan', 'darkgrey', 'darkkhaki', 'darkorange', 'darkorchid', 'darksalmon', 'fuchsia', 'gold', 
        'green', 'khaki', 'lightblue', 'lightcyan', 'lightgreen', 'lightgrey', 'lightpink', 'lightyellow', 
        'lime', 'magenta', 'olive', 'orange', 'pink', 'red', 'silver', 'yellow'],
        lines: 4,
        bootstrap: 4,
        onSelected: null
    };
